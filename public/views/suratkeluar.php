        ...
        <div class="card">
            <div class="card-body flex flex-col">
                <div class="flex flex-row justify-between items-center">
                    ...
                    <a href="<?= BASE_URL ?>suratkeluar/tambah"
                        class="rounded text-white badge bg-teal-900 text-xs p-2">
                        Tambah Data
            ...
            <div class="card-body flex flex-col">
                <table class="min-w-full leading-normal">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm"><?= $row['no_surat']; ?>
                            </td>
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                <?= $row['tanggal_surat']; ?></td>
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm"><?= $row['perihal']; ?></td>
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm"><?= $row['username']; ?>
                            </td>
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm"><?= $row['nama_divisi']; ?>
                            </td>
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            ...
                            <td class="flex px-5 py-5">
                                <a href="<?= BASE_URL; ?>viewsurat/<?= $row['id_surat']; ?>"
                                    class="badge bg-teal-700 text-white text-xs p-2 mx-1"><i
                                        class="fad fa-eye text-m"></i>view
                                </a>
                                ...
                                <a href="<?= BASE_URL; ?>approve/<?= $row['id_surat']; ?>"
                                    class="badge bg-red-500 text-white text-xs p-2"> <i class="fad fa-times text-m"></i>
                                    approve </a>
                                <?php } else { ?>
                                ...
                                <?php if ($level_user == 0) { ?>
                                <a href="<?= BASE_URL; ?>suratkeluar/update/<?= $row['id_surat']; ?>"
                                ...
                                <a onclick="return confirm('yakin ingin menghapus?')"
                                    href="<?= BASE_URL; ?>suratkeluar/hapus/<?= $row['id_surat']; ?>"
